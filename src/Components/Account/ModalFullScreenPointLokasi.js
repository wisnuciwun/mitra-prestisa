...
const ModalFullScreenPointLokasi = ({
  modalVisible,
  onClose,
  selectPointLocation = () => {},
}) => {
  ...
  const handleOnPressPinPointLocation = () => {
    const _data_map_pin = { data: dataLocation[0], geo_code: geoMarker }
    selectPointLocation(_data_map_pin)
  }
    ...
    >
      ...
      >
        ...
        <TouchableOpacity onPress={onClose}>
          <View
            style={{
              backgroundColor: Colors.neutralGray01 + '60',
              width: 38,
              height: 38,
      ...
      {!hideButtonFloat && (
        <ButtonBottomFloating
          ...
          onPress={handleOnPressPinPointLocation}
        />
      )}
    </Modal>
  )
...
export default ModalFullScreenPointLokasi
